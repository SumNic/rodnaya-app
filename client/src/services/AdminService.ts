...
export default class AdminService {
    ...
    static async fetchCleaningIsComplete(id_foul_message: number): Promise<AxiosResponse<boolean>> {
		return $api.post<boolean>('/fetch-cleaning-is-complete', {id_foul_message});
	}
}

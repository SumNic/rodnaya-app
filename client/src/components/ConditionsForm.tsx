		...
		<form id="condition" onSubmit={Condition}>
			...
			<div className="registr__block">
				...
				<label htmlFor="registr2">
					Я являюсь учредителем своей Родной партии. Целью моей Родной партии является возвращение в семьи энергии
					Любви. Моя Родная партия вернет народу образ жизни и обряды, способные навечно в семьях сохранять любовь. Моя
					Родная партия Родину законом узаконит.
				</label>
			</div>
			<div className="registr__block">
			...
			<div className="registr__block">
				...
				<label htmlFor="registr4">
					Я согласен, что информация о том, что я учредил свою Родную партию и декларация моей Родной партии, будут

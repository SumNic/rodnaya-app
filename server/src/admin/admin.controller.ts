...
export class AdminController {
    ...
    @UseGuards(RolesGuard)
    @UseGuards(JwtAuthGuard)
    async fetchCleaningIsComplete(@Body('id_foul_message') id_foul_message: number): Promise<boolean> {
        return await this.adminService.fetchCleaningIsComplete(id_foul_message);
    }
}
